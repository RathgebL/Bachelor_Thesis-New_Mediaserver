...
sudo systemctl list-timers --all | grep process_incoming
  ...
  Durch diese Automatisierung können Mitarbeitende der Bibliothek neue Mediendateien einfach in den Upload-Ordner kopieren, ohne direkt auf den Server zugreifen zu müssen. 
  Die Übertragung, Strukturierung und Integration in die bestehende Medienbibliothek erfolgen anschließend vollautomatisch.
