...
Server bilden das Fundament moderner IT-Infrastrukturen. In diesem Abschnitt werden grundlegende Begriffe erläutert, die historische Entwicklung skizziert und typische Einsatzszenarien von Medienservern dargestellt.

  \subsection{Begriffsdefinitionen}
  Definition zentraler Konzepte wie Server, Client, Medienserver und Streaming.
