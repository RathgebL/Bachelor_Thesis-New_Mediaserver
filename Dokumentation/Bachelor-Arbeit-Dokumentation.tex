...
insbesondere wegen seiner geringen Dateigrößen und breiten Unterstützung durch Endgeräte.\footcite[Vgl.][Kapitel~7.4, S.~699~ff.]{tanenbaum_computernetworks}  
...
wird heute von vielen Streamingdiensten und Plattformen (z.\,B. YouTube, iTunes, Spotify) als Standard eingesetzt.  
...
Dieses Format findet daher primär in professionellen Produktionsumgebungen oder für kurzfristige Verarbeitungsschritte Anwendung.  
...
Kapitelinformationen und mehrere Tonspuren in einer Datei vereinen kann.  
...
Es überzeugt durch hohe Kompatibilität mit Abspielgeräten und Streaming-Plattformen.\footcite[Vgl.][Kapitel~6.3, S.~274~ff.]{kurose_networking}  

\textbf{Metadatenstandards:}  
Für die effiziente Organisation und Suche von Medieninhalten sind Metadaten unverzichtbar.  
Bei Musikdateien sind ID3-Tags weit verbreitet, die Attribute wie Titel, Interpret, Album, Genre oder Coverbilder standardisiert in MP3-Dateien einbetten.  
Darüber hinaus existieren generische Standards wie der Dublin Core Metadata Standard, der insbesondere in Bibliotheks- und Archivkontexten eingesetzt wird, 
um digitale Ressourcen konsistent zu beschreiben und interoperabel zugänglich zu machen.\footcite[Vgl.][Kapitel~4.2]{steinmetz_multimedia}  
 
\subsection{Rechtsfragen}  
Neben technischen Aspekten spielen rechtliche Rahmenbedingungen eine zentrale Rolle:  

\textbf{Lizenzen und Lizenzmodelle:}  
Freie Software wie Jellyfin unterliegt meist der GPL, während kommerzielle Systeme wie Plex proprietäre Lizenzen verwenden. Auch bei verwendeten Codecs können Lizenzkosten anfallen (z.\,B. AAC, H.264).\footcite[Vgl.][S.~943]{nemeth_unixlinux}  

\textbf{Urheberrechtliche Rahmenbedingungen:}  
Die Bereitstellung von Medieninhalten unterliegt dem Urheberrecht. Privatkopien dürfen in vielen Rechtsordnungen nur im engen Rahmen erfolgen, eine öffentliche Zugänglichmachung (z.\,B. Streaming in einem Bibliotheksnetzwerk) setzt in der Regel entsprechende Nutzungsrechte voraus.\footcite[Vgl.][S.~946]{nemeth_unixlinux}  

\textbf{Bibliotheksrecht im Hochschulkontext:}  
Für Hochschulbibliotheken gelten besondere Ausnahmeregelungen im Urheberrechtsgesetz (UrhG), insbesondere im Rahmen von § 60a UrhG (Nutzungen für Unterricht und Lehre). Dennoch müssen Lizenzen und Verträge mit Rechteinhabern geprüft werden, bevor digitale Inhalte über einen Medienserver zugänglich gemacht werden.\footcite[Vgl.][S.~947]{nemeth_unixlinux}  
