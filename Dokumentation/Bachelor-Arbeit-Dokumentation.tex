...
die neben klassischen Serverkomponenten auch spezielle Anforderungen an Speicher und Datenübertragung stellen.
  ...
  Ein Server besteht aus zentralen Hardwarekomponenten wie Prozessor, Hauptspeicher, 
  Netzwerk- und Massenspeicherhardware. Für den Dauerbetrieb sind Aspekte wie 
  Zuverlässigkeit, Ausfallsicherheit, Energieeffizienz und Skalierbarkeit besonders wichtig. 
  Anders als bei Arbeitsplatzrechnern kommen häufig redundante Netzteile, 
  unterbrechungsfreie Stromversorgungen (USV) sowie spezielle Kühlungssysteme zum Einsatz, 
  ...
  funktionsfähig bleibt.\footcite[Vgl.][Kapitel~1.5.1]{tanenbaum_computernetworks}
  ...
  Katalogisierung und Bereitstellung multimedialer Inhalte notwendig.\footcite[Vgl.][Kapitel~2.3.1 und 2.3.2]{steinmetz_multimedia}

  \subsection{Betriebssysteme für Server}
  Zu den gängigsten Server-Betriebssystemen zählen insbesondere 
  Linux-Distributionen, Windows Server sowie UNIX-Derivate.\footcite[Vgl.][Kapitel~1.1]{nemeth_unixlinux} 
  ...
  vor allem als bevorzugte Plattform für Webserver wie Apache dient.\footcite[Vgl.][Kapitel~23]{nemeth_unixlinux} 
  ...
  wichtige Rolle spielt.\footcite[Vgl.][Kapitel~30.9]{nemeth_unixlinux}
  ...
  virtueller Maschinen auf einer physischen Hardware.\footcite[Vgl.][Kapitel~24]{nemeth_unixlinux} 
...
sie bieten hohe Bandbreiten, niedrige Latenzen und ermöglichen die zentrale Verwaltung großer Speicherpools.\footcite[Vgl.][S.~21858f.]{saravanamuthu2014study}  
...
und paralleler Zugriffslast.\footcite[Vgl.][Kapitel 3.1 und 3.2]{chen2004raid}
