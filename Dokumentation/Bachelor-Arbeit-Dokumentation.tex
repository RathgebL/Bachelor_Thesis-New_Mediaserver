...
\section{Testen und Fehlerbehebung}
  ...
  \subsubsection*{Variante 1: Eintrag in der \texttt{/etc/hosts}-Datei des Clients}
  ...
  \begin{minted}[breaklines, linenos]{bash}
  100.123.42.40   mediaserver.local
  \end{minted}
  ...
  \subsubsection*{Variante 2: Multicast-DNS (mDNS) mit Avahi auf dem Server}
