...
Damit soll der Aufbau des Medienservers in der Bibliothek nachvollziehbar und reproduzierbar gemacht werden.
  ...
  Nähere Informationen zu diesem Vorgang sind in der offiziellen Dokumentation verfügbar:\\
...
# Weitere nützliche Befehle siehe Docker-Abschnitt
    ...
    Nach dem Start des Containers kann die Weboberfläche von Navidrome im Browser über die Adresse\\
    \url{http://<SERVER-IP>:4533} aufgerufen werden.   
